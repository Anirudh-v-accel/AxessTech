...
/*==============================================================================
  Partner Slider JS
================================================================================*/
    $(".ep-partner__slider").owlCarousel({
      items: 2,
      autoplay: true,
      loop: true,
      touchDrag: true,
...
var itemCount = $(".ep-course__slider").children().length;

// Initialize OwlCarousel only if there's more than one item
if (itemCount > 1) {
  ...
  // If there's only one item, remove the OwlCarousel functionality
  $(".ep-course__slider").addClass('single-item').trigger('destroy.owl.carousel').removeClass('owl-carousel owl-loaded');
  $(".ep-course__slider").find('.owl-stage-outer').children().unwrap();
}
